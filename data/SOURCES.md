...
| Tholkappiyam Ezhuthathikaram, Sollathikaram, and Porulathikaram (379, 287, and 103 pairs) | Balasundaram's urai. | These texts were manually collected and aligned for v3. No automated parser is supplied because the final section selection and alignment were manual rather than a repeatable page-level crawl. |
